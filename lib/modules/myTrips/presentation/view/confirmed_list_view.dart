...
class ConfirmedListView extends StatefulWidget {
  final AnimationController animationController;
  final String type;
  const ConfirmedListView({Key? key, required this.animationController, required this.type,   })
      : super(key: key);
  @override
  State<ConfirmedListView> createState() => _ConfirmedListViewState();
}

class _ConfirmedListViewState extends State<ConfirmedListView> {
