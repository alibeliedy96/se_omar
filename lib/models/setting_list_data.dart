...
class SettingsListData {
  ...
  static List<SettingsListData> userInfoList = [
    ...
    SettingsListData(
      titleTxt: Loc.alized.username_text,
      subTxt: "Amanda Jane",
    ),
    SettingsListData(
      titleTxt: Loc.alized.mail_text,
      subTxt: "amanda@gmail.com",
    ),
    SettingsListData(
      titleTxt: Loc.alized.your_phone,
      subTxt: "+65 1122334455",
    ),
    // SettingsListData(
    //   titleTxt: Loc.alized.date_of_birth,
    //   subTxt: "20, Aug, 1990",
    // ),
    // SettingsListData(
    //   titleTxt: Loc.alized.address_text,
