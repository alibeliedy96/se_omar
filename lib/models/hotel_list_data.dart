...
class HotelListData {
  ...
  static List<HotelListData> hotelTypeList = [
    ...
    HotelListData(
      ...
      titleTxt: Loc.alized.backpacker_data,
      isSelected: false,
    ),
    HotelListData(
    ...
    HotelListData(
      ...
      titleTxt: Loc.alized.guest_house,
      isSelected: false,
    ),
    HotelListData(
      imagePath: Localfiles.hotelType_7,
      titleTxt: Loc.alized.motel,
      isSelected: false,
    ),
    HotelListData(
      imagePath: Localfiles.hotelType_8,
      titleTxt: Loc.alized.accommodation,
      isSelected: false,
    ),
    HotelListData(
      imagePath: Localfiles.hotelType_9,
      titleTxt: Loc.alized.bed_breakfast,
      isSelected: false,
    ),
  ];
